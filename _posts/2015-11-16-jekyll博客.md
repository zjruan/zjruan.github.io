...
1. 安装Redcarpet，安装Redcarpet有一些前置任务
	* 安装DevKit ：在ruby的根目录下新建DevKit（'C:\Ruby22-x64\Devkit'）,双击先前下载的Devkit包，选择该目录，cmd安装Devkit
	```cmd
	...
	```
	[不安装DevKit，引发的问题](https://github.com/micahgodbolt/sassbitesdemo/issues/4)
	...
	* 安装Redcarpet，[ruby插件官网](https://rubygems.org/)
	...
	gem install redcarpet -v 3.3.2	//可去插件的官网查看最新的插件版本
	```
